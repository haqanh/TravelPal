          ...
          >
            ...
            <form>
              <div class="mb-4 text-center relative">
                ...
                >
                  <div class="absolute inset-0 flex items-center justify-center">
                    ...
                    <div v-else class="flex flex-col items-center justify-center">
                      <img src="../assets/Camera.png" alt="Add Photo" class="h-7 w-7 mb-1 mx-auto">
                ...
                <div class="flex relative ">
                    <span class="rounded-l-md inline-flex  items-center px-3 border-t bg-white border-l border-b  border-gray-300 text-gray-500 shadow-sm text-sm">
                        <img src= "../assets/Trip Tag.png" width="15" height="15" fill="currentColor" viewBox="0 0 1792 1792">
                ...
                <div class="mb-4">
                  <div class="flex items-center mb-2">
                      ...
                      <div class="mr-2">
                          <img src="../assets/Calendar.png" alt="Calendar Icon" class="w-6 h-6">
                      </div>
                  </div>
              ...
              <!-- Cost Input -->
                ...
                <div class="flex relative">
                    <span class="rounded-l-md inline-flex  items-center px-3 border-t bg-white border-l border-b  border-gray-300 text-gray-500 shadow-sm text-sm">
                        <img src= "../assets/Stack Of Coins.png" width="15" height="15" fill="currentColor" viewBox="0 0 1792 1792">
                            <path d="M1792 710v794q0 66-47 113t-113 47h-1472q-66 0-113-47t-47-113v-794q44 49 101 87 362 246 497 345 57 42 92.5 65.5t94.5 48 110 24.5h2q51 0 110-24.5t94.5-48 92.5-65.5q170-123 498-345 57-39 100-87zm0-294q0 79-49 151t-122 123q-376 261-468 325-10 7-42.5 30.5t-54 38-52 32.5-57.5 27-50 9h-2q-23 0-50-9t-57.5-27-52-32.5-54-38-42.5-30.5q-91-64-262-182.5t-205-142.5q-62-42-117-115.5t-55-136.5q0-78 41.5-130t118.5-52h1472q65 0 112.5 47t47.5 113z">
                            </path>
                    </span>
