<template>
    <div class="flex items-center">
        <div class="trip-card relative 2xl:w-64 2xl:h-64 lg:w-42 lg:h-42 bg-white border border-gray-200 rounded-2xl custom-shadow">
            <img class="rounded-t-2xl 2xl:h-48 2xl:w-64 lg:w-42 lg:h-35 custom-shadow object-cover object-bottom" :src="TripImage" alt="No Image" />
