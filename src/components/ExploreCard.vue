<template>
    <div class="flex flex-col items-center justify-center">
        <div class="flex flex-col items-start space-y-3">
            <div class="bg-gray shadow-lg w-56 rounded-3xl" v-on:click="openGuide" v-if="isVisible">
                <div class="relative h-48 overflow-hidden bg-gray-200 rounded-3xl">
                    <img :src="card.guidePicPath" alt="Image" class="object-cover rounded-t-2xl h-full w-full">
                    <div class="flex absolute top-0 right-0 p-3">
                        <img :src="card.profilePicPath" alt="profile"
                            class="object-cover rounded-full h-7 w-7">
                    </div>
                    <div class="flex items-center absolute bottom-0 left-0 p-3">
                        <img :src="card.flagPath" alt="flag">
            ...
            <div class="w-56 flex justify-between items-center">
                ...
                <div @click="likeGuide">
                    <svg v-if="card.isLiked" xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 24 24"
                        stroke-width="1.5" stroke="red" class="h-5 w-5">
