    ...
    <ul class="space-y-10">
      <li>
        ...
        <ul class="grid grid-cols-2 gap-2">
          <li v-for="(country, index) in userData.Bucket_list" :key="index" class="flex items-center mt-2">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="info-card">
          ...
          <div class="stats-container text-white">
            <span class="text-lg font-semibold">{{ formatNumber(userData.Num_Visited) }}</span> Countries
          </div>
        </div>
        <div class="info-card2">
          <h3 class="text-l font-semibold mb-2">You've walked</h3>
          <div class="stats-container text-white">
            <span class="text-lg font-semibold">{{ formatNumber(userData.Steps) }}</span> Steps
          </div>
        </div>
      </div>
    </ul>
