...
import {Dialog as HeadlessDialog, DialogPanel,DialogTitle, TransitionRoot,TransitionChild, Disclosure, DisclosureButton, DisclosurePanel,} from '@headlessui/vue'
...
<TransitionRoot appear :show="isOpen" as="template">
    <HeadlessDialog as="div" class="relative z-10">
      <!-- <div class="fixed inset-0 bg-white bg-opacity-100 z-15" v-if="isOpen" @click="closeModal"></div> -->
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          ...
          >
            <DialogPanel class="panel_style">
              ...
              <DialogTitle as="h3" class="addGuide_style">
                Add Guide
              </DialogTitle>
              <br>
              ...
              <div class="mt-2">
                ...
                <Disclosure v-slot="{ open }">
                    ...
                    <span class="flex w-full right-5 space-x-3">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" :class="{ 'rotate-180': open, 'w-6': true, 'h-6': true }">
              ...
              <div class="mt-4">
                <button
                  ...
                  @click="closeModal"
                >
                <RouterLink to="/add-guide" class="inline-flex justify-center rounded-md border border-transparent bg-blue-100 px-4 py-2 text-sm font-medium text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2">Back</RouterLink>
                </button>
              </div>
            </DialogPanel>
          </TransitionChild>
