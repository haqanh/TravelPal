          ...
          <TransitionChild as="template" enter="ease-out duration-300"
            ...
            <DialogPanel
              ...
              <div class="text-right m-4">
                <button type="button"
                  class="bg-white rounded-lg p-2 justify-end text-right text-gray-400 hover:text-gray-500 hover:bg-indigo-200" @click="closeModal">
              ...
              <form class="bg-white rounded px-8 pb-8 mb-4">
                ...
                <div class="mb-4">
                  <label class="block text-gray-700 text-sm font-medium mb-2 font-['Poppins']" for="email">
                    Email
                  </label>
                  <input
                ...
                <div class="mb-6">
                  <label class="block text-gray-700 text-sm font-medium mb-2 font-['Poppins']" for="password">
                    Password
                  </label>
                  <input
                  ...
                  <div className="flex justify-center items-center text-center gap-1">
                    ...
                    <div className="Description text-blue-600 underline text-xs font-normal hover:cursor-pointer font-['Poppins']" @click="login = !login">Become a Pal now</div>
                  </div>
            ...
            <TransitionChild as="template" enter="ease-out duration-300"
              ...
              <DialogPanel
                ...
                <form class="bg-white rounded px-8 pb-8 mb-4">
                  ...
                  <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-medium mb-2 font-['Poppins']" for="signUpEmail">
                      Email
                    </label>
                    <input
                      class="shadow appearance-none border rounded-md w-full py-2 px-3 text-gray-700 leading-tight font-['Poppins'] focus:outline-none focus:shadow-outline"
                      id="signUpEmail" type="email" v-model="signUpEmail" placeholder="Email">
                  </div>
                  <div class="mb-2">
                    <label class="block text-gray-700 text-sm font-medium mb-2 font-['Poppins']" for="signUpPassword">
                      Password
                    </label>
                    <input
                      class="shadow appearance-none border rounded-md w-full py-2 px-3 text-gray-700 mb-3 leading-tight font-['Poppins'] focus:outline-none focus:shadow-outline"
                      id="signUpPassword" type="password" v-model="signUpPassword" placeholder="Enter your password">
                  </div>

                  <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-medium mb-2 font-['Poppins']" for="signUpConfirmPassword">
                      Confirm Password
                    </label>
                    <input
                      class="shadow appearance-none border rounded-md w-full py-2 px-3 text-gray-700 mb-3 leading-tight font-['Poppins'] focus:outline-none focus:shadow-outline"
                      id="signUpConfirmPassword" type="password" v-model="signUpConfirmPassword" placeholder="Confirm your password">
                ...
                <div className="flex justify-center items-center text-center gap-1">
                    <div className="Description text-zinc-900 text-xs font-normal font-['Poppins']">Already have an account?</div>
                    <div className="Description text-blue-600 underline text-xs font-normal hover:cursor-pointer font-['Poppins']" @click="login = !login">Log in here</div>
                </div>
